...
def test_generate_manifest_data():
    ...
    assert csv_data_str == "start_byte,end_byte\r\n0,9\r\n10,19\r\n20,29\r\n30,39\r\n40,49\r\n50,59\r\n60,69\r\n70,79\r\n80,89\r\n90,99\r\n"

@moto.mock_aws
def test_assert_source_bucket_region():
    test_bucket = "test-bucket"
    conn = boto3.resource("s3", region_name="us-west-2")
    conn.create_bucket(Bucket=test_bucket, CreateBucketConfiguration={"LocationConstraint": "us-west-2"})
...
def test_lambda_handler_write_file(apigw_event, mocker):
    ...
    conn.create_bucket(Bucket=test_bucket, CreateBucketConfiguration={"LocationConstraint": test_region})
